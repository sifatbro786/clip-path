...
export default function RecentWork() {
    ...
    return (
        <section className="bg-[#FAF8F4]">
            {" "}
            {/* Matched section background with image */}
                    ...
                    <div className="flex-1">
                        ...
                        <HeaderSection
                            ...
                            heading={[
                                ...
                                { text: "samples.", color: "secondary" },
                            ]}
                            paragraph="Hover any image to see the original. Each sample shows the complexity tier and price."
                        />
                    </div>
